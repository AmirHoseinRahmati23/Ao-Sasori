...
namespace IranOtaku.Data.Entities
{
    public class Anime : object
    {
        ...
        public virtual ICollection<AnimeComment> Comments { get; set; }
        public virtual ICollection<HomePageSlider> Sliders { get; set; }
        public virtual ICollection<AnimeSeason> Seasons { get; set; }
        public virtual ICollection<AnimeReport> Reports { get; set; }
